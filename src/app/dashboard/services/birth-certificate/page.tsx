...
export default function BirthCertificateServicePage() {
  return (
    <DashboardLayout title="Birth Certificate" subtitle="Chat with us to process your request">
        ...
        <Card className="bg-white border-gray-200 text-gray-900">
          <CardHeader>
            <div className="flex items-center space-x-3">
              ...
              <CardTitle className="text-gray-900">Birth Certificate Service</CardTitle>
            </div>
