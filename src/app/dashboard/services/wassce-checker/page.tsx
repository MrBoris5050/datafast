...
export default function WassceCheckerPage() {
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `wassce-vouchers-${new Date().toISOString().split('T')[0]}.csv`
  ...
  const wassceVouchers = vouchers.filter(v => v.type === 'WASSCE')

  return (
    <DashboardLayout title="WASSCE Checker" subtitle="Purchase and verify WASSCE result checker">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="bg-white border-gray-200">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-500">Total WASSCE Vouchers</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-gray-900">{stats.wassce.total}</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white border-gray-200">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{stats.wassce.unused}</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white border-gray-200">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">{stats.wassce.used}</div>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="vouchers" className="space-y-4">
          ...
          <TabsContent value="vouchers" className="space-y-4">
            <Card className="bg-white border-gray-200">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <CardTitle className="text-gray-900">WASSCE Result Checker</CardTitle>
                      <CardDescription className="text-gray-500">Use your voucher to check WASSCE results</CardDescription>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2">
                    <Dialog open={isPurchaseDialogOpen} onOpenChange={setIsPurchaseDialogOpen}>
                      ...
                      <DialogContent className="bg-white border-gray-200 text-gray-900">
                        <DialogHeader>
                          <DialogTitle>Purchase WASSCE Vouchers</DialogTitle>
                          <DialogDescription className="text-gray-500">
                            Buy vouchers to check WASSCE results. Each voucher can be used 3 times for the same index number!.
                          </DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="text-sm text-gray-500">
                            <p>Price per voucher: ₵{wasscePrice.toFixed(2)}</p>
                            <p>Total cost: ₵{(parseInt(purchaseQuantity) * wasscePrice).toFixed(2)}</p>
                          </div>
                        </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="bg-gray-100 rounded-lg p-4 space-y-2">
                              <div className="flex justify-between">
                                ...
                                <span className="font-semibold">WASSCE Results Checker</span>
                              </div>
                              <div className="flex justify-between">
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">My WASSCE Vouchers</h3>
                  <p className="text-gray-500 mb-4">
                    {stats.wassce.unused > 0 
                      ? `You have ${stats.wassce.unused} unused WASSCE voucher${stats.wassce.unused !== 1 ? 's' : ''} available`
                      : 'You have no unused WASSCE vouchers. Purchase vouchers to get started.'}
                  </p>
                  <Button 
            ...
            <Card className="bg-white border-gray-200">
              <CardHeader>
                <CardTitle className="text-gray-900">My WASSCE Vouchers</CardTitle>
                <CardDescription className="text-gray-500">
                  View and manage your WASSCE result checker vouchers
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loading ? (
                  <div className="text-center py-8 text-gray-500">Loading vouchers...</div>
                ) : wassceVouchers.length === 0 ? (
                  <div className="text-center py-8 text-gray-500">No WASSCE vouchers found</div>
                ) : (
